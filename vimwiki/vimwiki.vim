...
syn region wikiBlueRegion start='<bl' end='>'
...
" Personal syntax highlighting for wiki
hi wikiBlueRegion ctermfg=blue  guifg=#0000FF
hi wikiCyanRegion ctermfg=cyan  guifg=#00CED1
hi wikiGreenRegion ctermfg=green  guifg=#98FB98
hi wikiPurpleRegion ctermfg=Magenta  guifg=#ae81ff
hi wikiRedRegion ctermfg=red  guifg=#fb4934
hi wikiOrangeRegion ctermfg=yellow  guifg=#d79921
hi wikiYellowRegion ctermfg=lightyellow  guifg=#E6DB74

hi wikiDateRegion ctermfg=cyan  guifg=#98FB98
hi wikiDot ctermfg=blue  guifg=#0000FF
hi wikiStar ctermfg=Magenta  guifg=#00CED1
hi wikiBang ctermfg=red  guifg=#fb4934
hi wikiLine ctermfg=yellow  guifg=#d79921
hi wikiComment ctermfg=green  guifg=#ae81ff
