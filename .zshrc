...
alias .acore_update='cd $HOME/Code2/C++/AzerothCore-wotlk-with-NPCBots && git pull && cd modules/mod-eluna && git pull https://github.com/azerothcore/mod-eluna master && cd ../..'
