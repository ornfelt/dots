...
-- theme.font                                      = "JetBrainsMono Nerd Font:size=11"
theme.font                                      = "JetBrainsMono Nerd Font:size=11:style=regular:antialias=true:autohint=true", "JoyPixels:pixelsize=13:antialias=true:autohint=true"
theme.taglist_font                              = "JetBrainsMono Nerd Font:size=11"
...
local colblue = "#458588"
local colblue2 = "#83a598"
local colred =  "#cc241d"
local colred2 =  "#fb4934"
local colgreen = "#98971a"
local colgreen2 = "#b8bb26"
local colcyan = "#689d6a"
local colcycan2 = "#8ec07c"
local colpink = "#b16286"
local colpink2 = "#d3869b"
local colgrey = "#a89984"
local colgrey2 = "#928374"
local colyellow = "#d79921"
local colyellow2 = "#fabd2f"
...
theme.weather = lain.widget.weather({
    ...
    notification_preset = { font = "JetBrainsMono Nerd Font:size=12", fg = theme.fg_normal },
