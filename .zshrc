...
alias .ioq32='$HOME/Code2/C/ioq3/build/Release_golden/ioquake3 +set sv_pure 0 +set vm_game 0 +set vm_cgame 0 +set vm_ui 0'
...
alias .git_status="$HOME/.local/bin/my_scripts/git_status.sh"
alias .git_check="$HOME/.local/bin/my_scripts/git_check_repos.sh"
alias .cmake="$HOME/.local/bin/my_scripts/2025/cmake.sh"
alias .cmake_py="$HOME/.local/bin/my_scripts/2025/cmake_py.sh"
alias .cmake_old="$HOME/.local/bin/my_scripts/2025/cmake_old.sh"
alias .cmake_build="$HOME/.local/bin/my_scripts/2025/cmake_build.sh"
alias .build="$HOME/.local/bin/my_scripts/2025/build.sh"
#alias .build_py="python $HOME/Documents/my_notes/scripts/build.py"
alias .build_py="$HOME/.local/bin/my_scripts/2025/build_py.sh"
alias .fr="$HOME/.local/bin/my_scripts/2025/fr.sh"
alias .fr_py="$HOME/.local/bin/my_scripts/2025/fr_py.sh"
alias .fr_cs="$HOME/.local/bin/my_scripts/2025/fr_cs.sh"
alias .pkg="$HOME/.local/bin/my_scripts/2025/pkg.sh"
alias .proc="$HOME/.local/bin/my_scripts/2025/proc.sh"
...
alias .help_old="$HOME/.local/bin/my_scripts/help_old.sh"
alias .search="$HOME/.local/bin/my_scripts/2025/search.sh"
alias .search_conf="$HOME/.local/bin/my_scripts/2025/search_conf.sh"
alias .search_env="$HOME/.local/bin/my_scripts/2025/search_env.sh"
...
alias .map="cd $HOME/Documents/my_notes/scripts/random/maps_data && echo 'Usage examples:\npython app.py'"
alias .trans="cd $HOME/Code2/Python/my_py/transaction-dashboard && echo 'Usage examples:\npython app.py'"
alias .mov="cd $HOME/Documents/my_notes/scripts/files/mov && echo 'Usage examples:\nnpm run start'"
...
alias .gr="$HOME/.local/bin/my_scripts/2025/restore_ws_only.sh"
alias .gp="$HOME/.local/bin/my_scripts/2025/git_pick.sh"
alias nvcs="$HOME/.local/bin/my_scripts/2025/nvcs.sh"
