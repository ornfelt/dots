...
local commands = {
  ...
  { label = "DiffHere", cmd = "DiffHere" },
  { label = "GitTab", cmd = "GitTab" },
  { label = "GitTabC", cmd = "GitTabC" },
  { label = "GitTabHere", cmd = "GitTabHere" },
  { label = "GitTabCHere", cmd = "GitTabCHere" },
  ...
  { label = "Config - CycleGrepBackend", cmd = "CycleGrepBackend" },
  ...
  { label = "Config - ToggleUseTsMdViewer", cmd = "ToggleUseTsMdViewer" },
  ...
  { label = "SkeletonCopy with metadata", cmd = "SkeletonCopy metadata" },
  ...
  { label = "MdCopyAs", cmd = "MdCopyAs" },
  { label = "MdUnlink", cmd = "MdUnlink" },
  { label = "MdOpen", cmd = "MdOpen" },
  -- GP
