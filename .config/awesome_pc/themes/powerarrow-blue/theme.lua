    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
           ...
           -- wibox.container.background(wibox.container.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, 4, 7), "#343434"),
            ...
            arrow("#8ec07c", "#458588"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, 2, 3), "#458588"),
            arrow("#458588", "#8ec07c"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, 3, 4), "#8ec07c"),
            arrow("#8ec07c", "#458588"),
            ...
            arrow("#458588", "#8ec07c"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#8ec07c"),
            arrow("#8ec07c", "#458588"),
            wibox.container.background(wibox.container.margin(clock, 4, 8), "#458588"),
            arrow("#458588", "alpha"),
            --]]
            s.mylayoutbox,
        },
