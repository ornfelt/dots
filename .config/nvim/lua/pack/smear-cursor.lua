...
-- Presets from the smear-cursor README examples. Mirrored in lua/plugins/smear-cursor.lua.
local SMEAR_PRESETS = {
...
return {
  ...
  config = function()
    require("smear_cursor").setup(smear_preset_opts({ enabled = not terminal_draws_smear() }))
  end,
}
